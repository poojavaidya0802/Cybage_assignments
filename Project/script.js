var myapp = angular.module("Myapp",['ngRoute']);
		...
		myapp.controller('author_controller',['$location','$scope','$http',function($location,$scope,$http){
		...
		myapp.controller('book_controller',['$location','$scope','$http',function($location,$scope,$http){
			...
			/*$scope.sites=[{site_name:'Flipkart'},{site_name:'Amazon'},{site_name:'Snapdeal'},{site_name:'Myntra'},{site_name:'Ebay'}];*/
			...
			$scope.edit_clicked=1;
			$scope.func_edit=function(curr_skills){
				$scope.edit_clicked =0;
//console.log(typeof(curr_skills));
				//console.log($scope.folder);
				for(i=0;i<curr_skills.length;i++){
					console.log(curr_skills[i]);
